...
`0.2.0-alpha.1` is the first installable ARM64 Alpha. It targets macOS 13 or newer and packages its native application, static `whisper.cpp` CLI and multilingual tiny model together.
