...
SOURCE_FILE="$ROOT_DIR/scripts/run_pushwrite_product_validation.swift"
OUTPUT_DIR="$(mktemp -d /tmp/pushwrite-product-validation.XXXXXXXX)"
MODULE_CACHE_DIR="$OUTPUT_DIR/module-cache"
TOOL_PATH="$OUTPUT_DIR/run_pushwrite_product_validation"
