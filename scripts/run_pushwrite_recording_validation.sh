...
SOURCE_FILE="$ROOT_DIR/scripts/run_pushwrite_recording_validation.swift"
OUTPUT_DIR="$(mktemp -d /tmp/pushwrite-recording-validation.XXXXXXXX)"
MODULE_CACHE_DIR="$OUTPUT_DIR/module-cache"
TOOL_PATH="$OUTPUT_DIR/run_pushwrite_recording_validation"
